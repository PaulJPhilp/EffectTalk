 ...
 * ```
 */
export const seq = (...children: Ast[]): SeqNode => ({
  type: "seq",
  children,
});
 ...
 * ```
 */
export const alt = (...children: Ast[]): AltNode => ({
  type: "alt",
...
export const noncap = (child: Ast): NonCapNode => ({
  type: "noncap",
  child,
});
...
export const lookahead = (child: Ast): AssertionNode => ({
  type: "assertion",
  kind: "lookahead",
  child,
});

export const negativeLookahead = (child: Ast): AssertionNode => ({
  type: "assertion",
  kind: "negative-lookahead",
  child,
});

export const lookbehind = (child: Ast): AssertionNode => ({
  type: "assertion",
  kind: "lookbehind",
  child,
});

export const negativeLookbehind = (child: Ast): AssertionNode => ({
  type: "assertion",
 ...
 */
const emitNode = (node: Ast, dialect: "js" | "re2" | "pcre"): string => {
  switch (node.type) {
    case "lit":
      return node.value;
    case "raw":
 ...
 */
const compareNodes = (a: Ast, b: Ast): number => {
