...
describe("SessionStore", () => {
  ...
  it("should handle focus navigation", () =>
    Effect.gen(function* () {
      const store = yield* SessionStore;
      const block1 = { ...initialSession.blocks[0], id: "1", command: "cmd1", status: "idle" as const, stdout: "", stderr: "", startTime: 0, metadata: {} };
      const block2 = { ...initialSession.blocks[0], id: "2", command: "cmd2", status: "idle" as const, stdout: "", stderr: "", startTime: 0, metadata: {} };
      const block3 = { ...initialSession.blocks[0], id: "3", command: "cmd3", status: "idle" as const, stdout: "", stderr: "", startTime: 0, metadata: {} };
