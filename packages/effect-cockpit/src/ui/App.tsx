...
export const App: React.FC<AppProps> = ({ session, slashCommands, onExecute, onFocusNext, onFocusPrev }) => {
  ...
  return (
    <Box flexDirection="column" height="100%">
      ...
      <Box flexDirection="column" marginTop={1}>
        <Box paddingX={1}>
          <Text dimColor>
            WD: {session.workingDirectory} | Shift+Up/Down: Nav | Ctrl+B: Toggle Sidebar
          </Text>
        </Box>
